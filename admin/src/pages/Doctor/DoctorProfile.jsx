  ...
  return profileData && (
    <div>
      ...
      <div className="flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white">
        ...
        {
          isEdit
            ? <button onClick={updateProfile} className="px-4 py-1 border bo border-[#5F6FFF] text-sm rounded-full mt-5 hover:bg-[#5F6FFF] hover:text-white transition-all">Save</button>
            : <button onClick={() => setIsEdit(true)} className="px-4 py-1 border bo border-[#5F6FFF] text-sm rounded-full mt-5 hover:bg-[#5F6FFF] hover:text-white transition-all">Edit</button>
        }
